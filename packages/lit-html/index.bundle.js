...
var _templateObject = /*#__PURE__*/ _taggedTemplateLiteral(["<div>Hello ", " my friend!</div>"], ["<div>Hello ", " my friend!</div>"]);
...
var helloTemplate = function helloTemplate(name) {
  return (0, _litHtml.html)(_templateObject, name);
}; // Call the function with some data, and pass the result to render()


window.customElements.define('my-name', function (_CustomElement2) {
  _inherits(MyName, _CustomElement2);
  ...
  _createClass(MyName, [{
    ...
    value: function render() {
      (0, _litHtml.render)(helloTemplate('Steve'), document.body);
    }
  }]);

  return MyName;
}(_CustomElement)); // This renders <div>Hello Steve!</div> to the document body
