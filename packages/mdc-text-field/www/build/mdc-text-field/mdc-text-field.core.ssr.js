...
var s=document.querySelector("script[data-core='mdc-text-field.core.ssr.js'][data-path]");if(s){publicPath=s.getAttribute('data-path');}
...
})({},"mdc-text-field","hydrated","/build/mdc-text-field/");