...
var _litElement = __webpack_require__(3);

var _litHtml = __webpack_require__(0);

var _mdcClasses = __webpack_require__(4);

var _mdcMaterial = _interopRequireDefault(__webpack_require__(5));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

class MDCMaterial extends (0, _mdcClasses.MDCClassesMixin)(_litElement.LitElement) {
  constructor() {
    super();
    const styleEl = document.createElement('style');
    styleEl.innerHTML = 'div {background: blue;}'; // this.append(styleEl)
  } // Getters
  ...
  get styles() {
    return _mdcMaterial.default.toString();
  } // Templating
...
class LitElement extends HTMLElement {
  constructor() {
    ...
    for (const prop in this.constructor.properties) {
      const {
        value
      } = this.constructor.properties[prop];
  ...
  renderCallback() {
    (0, _litHtml.render)(this.render(this.props), this.rootEl);
...
exports.MDCClassesMixin = MDCClassesMixin;

function MDCClassesMixin(superclass = class {}) {
